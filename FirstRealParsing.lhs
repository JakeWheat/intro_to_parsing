...
TODO: restructure this to create parsers for num, var, parens, then
parens with num or var separately before introducting the expression
type, then go through the Add issues.
